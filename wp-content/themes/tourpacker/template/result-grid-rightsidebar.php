<?php
/*
*Template Name: Result Grid Right Sidebar Page
*
*/
	get_header();
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-8 col-md-9">
					...
					<div class="GridLex-gap-20-wrappper package-grid-item-wrapper on-page-result-page alt-smaller" id="filter-search-list">
							...
							<div class="GridLex-col-4_sm-6_xs-12 mb-20">
								<div class="package-grid-item"> 
									<a href="<?php the_permalink(); ?>">
										<div class="image">
											<img src="<?php echo esc_url($images_tour_search); ?>" alt="Tour Package" />
									...
									<div class="more-less-wrapper">
										...
										<div id="property_type_more_less" class="collapse"> 
								            ...
								            ?>
												...
												<input type="hidden" name="search_for_start" id="search_for_start<?php echo esc_attr($i); ?>"/>
												<script>
												jQuery(function($){
									                $(document).ready(function(){
									                	var count_js=0;

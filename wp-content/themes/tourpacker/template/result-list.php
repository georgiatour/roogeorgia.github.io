<?php
/*
*Template Name: Result Search Page
*
*/
	get_header();
			...
			<div class="row">
					...
					<aside class="sidebar with-filter">
						...
						<div class="sidebar-search-wrapper bg-light-2">
							...
							<div class="sidebar-search-header">
								<h4><?php echo esc_html__('Search Again','tourpacker'); ?></h4>
							</div>
						...
						<div class="sidebar-header clearfix">
							<h4><?php echo esc_html__('Filter Results','tourpacker'); ?></h4>
							<a href="#" class="sidebar-reset-filter"><i class="fa fa-times"></i> <?php echo esc_html__('reset filter','tourpacker'); ?></a>
						</div>
						
						<div class="sidebar-inner">
						
							<div class="sidebar-module">
								<h6 class="sidebar-title"><?php echo esc_html__('Name Contain','tourpacker'); ?></h6>
										...
										<div class="input-group">
											...
											<span class="input-group-btn">
												...
												jQuery(document).ready(function($) {
													var $content = $("body #filter-search-list");
	 												jQuery("button.result-search-for").on("click",function(){
													    var search_for = $('#search-for1').val(); 
													    $( "#filter-search-list" ).empty();
													    $.ajax({
													    	type : "GET",
													        url: ajaxurl,
							...
							<div class="sidebar-module">
								<h6 class="sidebar-title"><?php echo esc_html__('Star Range','tourpacker'); ?></h6>
								<div class="sidebar-module-inner">
									<input id="star_range" />
							...
							<div class="sidebar-module">
								...
								<h6 class="sidebar-title"><?php echo esc_html__('Starting Point','tourpacker'); ?></h6>
								<div class="sidebar-module-inner">
								<?php 
					              $i=1;
					              $j=0;
					            ...
					            <input type="hidden" name="search_for_start" id="search_for_start"/>
									...
									<div class="more-less-wrapper">
										...
										<button class="btn btn-more-less collapsed" data-toggle="collapse" data-target="#property_type_more_less"><?php echo esc_html__('Show more','tourpacker'); ?></button>
				...
				<div class="col-sm-8 col-md-9">
					...
					if($wp_query->have_posts()):
					    ...
					    $tour_country = get_post_meta( get_the_ID(), '_cmb_tour_info_country',true);
					    if(isset($_POST['destination_hidden'])){
					    	$destination_hidden = $_POST['destination_hidden'];
						}else{

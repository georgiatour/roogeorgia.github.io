    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3">
          ...
          <h1 class="hero-title"><?php if( isset($theme_option['index_page_text_title']) && $theme_option['index_page_text_title'] != ''){ echo esc_attr($theme_option['index_page_text_title']); }else{} ?></h1>
          ...
          ?>
                ...
                <div id="bootstrap-carousel-slider" class="carousel slide" data-ride="carousel" data-interval="5000">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <?php
                        ...
                        if(isset($gallery['ids'])){  
                            ...
                            foreach( $img_ids AS $img_id ){
                                ...
                                $params = array( 'width' => 833, 'height' => 315 );
                                $image_gallery = bfi_thumb( $image_src[0], $params );
                    ...
                    <div class="item <?php if($i==1){echo 'active';}else{} ?>">
                      <div class="image">
                        <img src="<?php echo esc_url($image_gallery) ?>" alt="Image" />
                      </div>
            ...
            <?php } ?>
              ...
              <div class="blog-content">
                ...
                <a href="<?php the_permalink(); ?>" class="btn-blog"><?php if(isset($theme_option['index_page_text_read']) && $theme_option['index_page_text_read'] != ''){ echo esc_attr($theme_option['index_page_text_read']);}else{echo esc_html__('Read More','tourpacker');} ?> <i class="fa fa-long-arrow-right"></i></a>
              </div>
